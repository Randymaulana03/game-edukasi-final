...
export const wordsLevel2 = [
  ...
  { id: 4, label: 'Dasi', answer: 'DASI', image: '/images/dasi.png', grid: { rows: 4, cols: 4 } },
  { id: 5, label: 'Ember', answer: 'EMBER', image: '/images/ember.png', grid: { rows: 5, cols: 5 } },
  { id: 6, label: 'Foto', answer: 'FOTO', image: '/images/foto.png', grid: { rows: 4, cols: 4 } },
  { id: 7, label: 'Gelas', answer: 'GELAS', image: '/images/gelas.png', grid: { rows: 5, cols: 5 } },
  { id: 8, label: 'Handuk', answer: 'HANDUK', image: '/images/handuk.png', grid: { rows: 6, cols: 6 } },
  { id: 9, label: 'Ikan', answer: 'IKAN', image: '/images/ikan.png', grid: { rows: 4, cols: 4 } },
  { id: 10, label: 'Kipas', answer: 'KIPAS', image: '/images/kipas.png', grid: { rows: 5, cols: 5 } },
  { id: 11, label: 'Vas', answer: 'VAS', image: '/images/vas.png', grid: { rows: 3, cols: 3 } },
